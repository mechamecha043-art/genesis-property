...
import { MessageCircle, MapPin, Bed, Bath, Car, CheckCircle2, ArrowRight, HomeIcon, Layers, Store, Ruler, Building2, ChevronUp, Menu } from 'lucide-react'
...
// Property data based on provided structure
const propertyData = [
  {
    phase: "Phase 1",
    units: [
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        image: "urban-beverly-treetops.jpg"
      },
      {
        name: "Urban Beverly",
        price: 610000000,
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        image: "hive-parkhills-boulevard.jpg"
      },
      {
...
// Gallery Data - Menggunakan nama file gambar yang ada
const galleryImages = [
  // Exterior - Phase 1
  { src: '/type-x2.jpg', title: 'Type X2 - Phase 1', category: 'Exterior' },
  { src: '/type-x2-park.jpg', title: 'Type X2 Park', category: 'Exterior' },
  { src: '/type-y.jpg', title: 'Type Y', category: 'Exterior' },

  // Exterior - Phase 2
  { src: '/cendana-living-p2.jpg', title: 'Cendana Living - Phase 2', category: 'Exterior' },
  { src: '/type-x3.jpg', title: 'Type X3', category: 'Exterior' },
  { src: '/q21.jpg', title: 'Q21', category: 'Exterior' },
  { src: '/q11.jpg', title: 'Q11', category: 'Exterior' },

  // Exterior - Phase 3
  { src: '/q23.jpg', title: 'Q23', category: 'Exterior' },
  { src: '/x6.jpg', title: 'X6', category: 'Exterior' },
  { src: '/cendana-living.jpg', title: 'Cendana Living', category: 'Exterior' },
  { src: '/cendana-suite.jpg', title: 'Cendana Suite', category: 'Exterior' },

  // Exterior - Phase 5
  { src: '/treetops-livin.jpg', title: 'Treetops Livin', category: 'Exterior' },
  { src: '/gold-livin.jpg', title: 'Gold Livin', category: 'Exterior' },
  { src: '/goldtop-livin.jpg', title: 'Goldtop Livin', category: 'Exterior' },
  { src: '/quartz-livin.jpg', title: 'Quartz Livin', category: 'Exterior' },
  { src: '/bronze.jpg', title: 'Bronze', category: 'Exterior' },

  // Exterior - Phase 6
  { src: '/bronze-alfa-b.jpg', title: 'Bronze Alfa B', category: 'Exterior' },
  { src: '/silver-alfa.jpg', title: 'Silver Alfa', category: 'Exterior' },
  { src: '/treetops-alfa.jpg', title: 'Treetops Alfa', category: 'Exterior' },
  { src: '/gold-alfa.jpg', title: 'Gold Alfa', category: 'Exterior' },
  { src: '/goldtops-alfa.jpg', title: 'Goldtops Alfa', category: 'Exterior' },
  { src: '/cendana-alfa.jpg', title: 'Cendana Alfa', category: 'Exterior' },

  // Exterior - Phase 7
  { src: '/goldtop-beverly.jpg', title: 'Goldtop Beverly', category: 'Exterior' },
  { src: '/gold-beverly.jpg', title: 'Gold Beverly', category: 'Exterior' },
  { src: '/urban-beverly-treetops.jpg', title: 'Urban Beverly Treetops', category: 'Exterior' },
  { src: '/urban-beverly.jpg', title: 'Urban Beverly', category: 'Exterior' },
  { src: '/bronze-beverly.jpg', title: 'Bronze Beverly', category: 'Exterior' },

  // Interior
  { src: '/living-room.jpg', title: 'Living Room', category: 'Interior' },
  { src: '/living-room-gold.jpg', title: 'Gold Living Room', category: 'Interior' },
  { src: '/bedroom-modern.jpg', title: 'Modern Bedroom', category: 'Interior' },
  { src: '/bedroom-interior.jpg', title: 'Bedroom Interior', category: 'Interior' },
  { src: '/kitchen-modern.jpg', title: 'Modern Kitchen', category: 'Interior' },
  { src: '/kitchen-gold.jpg', title: 'Gold Kitchen', category: 'Interior' },
  { src: '/bathroom-luxury.jpg', title: 'Luxury Bathroom', category: 'Interior' },
  { src: '/bathroom-gold.jpg', title: 'Gold Bathroom', category: 'Interior' },

  // Commercial
  { src: '/hive-park-avenue.jpg', title: 'Hive Park Avenue', category: 'Commercial' },
  { src: '/hive-parkhills-boulevard.jpg', title: 'Hive Parkhills Boulevard', category: 'Commercial' },
  { src: '/hive-teraza.jpg', title: 'Hive Teraza', category: 'Commercial' },
  { src: '/hive-aurora.jpg', title: 'Hive Aurora', category: 'Commercial' },
  { src: '/soho-treetops.jpg', title: 'SOHO Treetops', category: 'Commercial' },
  { src: '/park-exchange.jpg', title: 'Park Exchange', category: 'Commercial' }
]
...
function PropertyCard({ unit }: { unit: any }) {
  ...
  const imageUrl = unit.image ? `/${unit.image}` : '/townhouse-exterior.jpg'
...
export default function Home() {
  ...
  const commercialPhase = propertyData.find(item => item.phase.includes('Commercial'))
  ...
  return (
    <div className="min-h-screen bg-zinc-950 pb-20 md:pb-0">
      ...
      {commercialPhase && (
        <section className="py-20 px-4 bg-zinc-950">
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {commercialPhase.units.map((unit, index) => {
                const imageUrl = unit.image ? `/${unit.image}` : '/shop-house.jpg'
                return (
                  <Card key={`commercial-${index}`} className="bg-zinc-800/50 border-white/10 overflow-hidden hover:border-amber-500/30 transition-all group">
                    <div className="relative h-48">
                      <Image
                        src={imageUrl}
      ...
      <section id="gallery" className="py-20 px-4 bg-zinc-950">
        <div className="container mx-auto max-w-7xl">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 text-center font-playfair">
            Galeri <span className="text-amber-400">Properti</span>
          </h2>
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto text-center mb-12">
            Jelajahi koleksi foto properti kami mulai dari tipe rumah, interior, hingga area komersial
          </p>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <Badge className="mb-2 bg-amber-500/90 text-zinc-950 border-amber-500">
                      {image.category}
                    </Badge>
